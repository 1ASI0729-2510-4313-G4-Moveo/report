...
| US23 | Diagrama de clases | **Como** desarrollador del equipo **quiero** tener el diagrama de clases que represente la estructura actual del sistema **para** comprender la relación entre entidades y facilitar el mantenimiento del código | **Escenario 1:** <br> **Dado** que el equipo ha implementado nuevas entidades <br> **Cuando** se revisa el diseño del sistema <br> **Entonces** el diagrama debe reflejar las clases con sus atributos y relaciones principales <br> **Escenario 2:** <br> **Dado** que el equipo trabaja de forma colaborativa <br> **Cuando**  otros desarrolladores consulten el modelo <br> **Entonces** Entonces el diagrama debe estar accesible desde el repositorio del proyecto o sistema compartido | EP07 |
| US24 | Diagrama de Base de Datos | **Como** miembro del equipo **quiero** contar con un diagrama de base de datos que represente las tablas y relaciones **para** tener claridad sobre la estructura de persistencia de datos del sistema | **Escenario 1:** <br> **Dado** que se han creado o modificado tablas durante el sprint <br> **Cuando** se visualiza el diagrama <br> **Entonces** ve una lista con cada reserva, fechas y estado. <br> **Escenario 2:** <br> **Dado** que otros integrantes necesitan referencias <br> **Cuando** otros desarrolladores consulten el modelo <br> **Entonces** debe encontrarse almacenado y disponible en el entorno colaborativo del proyecto| EP07 |
| US25 | Modelo C4 | **Como** desarrollador del equipo **quiero**  disponer del modelo C4 del sistema **para** visualizar los niveles de contexto, contenedor o componente según se requiera | **Escenario 1:** <br> **Dado** que se desea entender la arquitectura general <br> **Cuando** se accede al modelo <br> **Entonces** se debe mostrar la relación entre el sistema y sus actores externos (nivel de contexto) <br> **Escenario 2:** <br> **Dado** que se requieren detalles técnicos internos <br> **Cuando**  se visualizan los niveles de contenedores o componentes <br> **Entonces** debe reflejar la organización interna de los servicios de forma clara y estructurada | EP07 |
| US26 | Métodos de pago | **Como** usuario **quiero**  quiero poder registrar uno o más métodos de pago en mi cuenta **para** realizar reservas de forma rápida y segura | **Escenario 1:** <br> **Dado** que soy un usuario autenticado <br> **Cuando** accedo a la sección de pagos y completo los datos <br> **Entonces** el sistema guarda el método de pago y lo asocia a mi cuenta <br> **Escenario 2:** <br> **Dado**  que ingreso un número de tarjeta no válido <br> **Cuando**   intento guardar el método de pago <br> **Entonces** el sistema muestra un mensaje indicando el error | EP06 |
| US27 | Edición de métodos de pago | **Como**  usuario **quiero**   poder editar o eliminar mis métodos de pago guardados **para** mantener la información financiera actualizada | **Escenario 1:** <br> **Dado** que ya tengo un método guardado <br> **Cuando**  accedo a la opción de editar <br> **Entonces** puedo modificar los datos de la tarjeta o eliminarla <br> **Escenario 2:** <br> **Dado** que realicé cambios <br> **Cuando**  los guardo <br> **Entonces** el sistema actualiza los datos y muestra un mensaje de éxito | EP06 |
| US28 | Edición de perfil | **Como** usuario **quiero**  quiero poder editar mi información personal **para** para mantener mi cuenta actualizada | **Escenario 1:** <br> **Dado** que soy usuario autenticado <br> **Cuando** entro a la sección de perfil <br> **Entonces** puedo modificar mis datos y guardarlos <br> **Escenario 2:** <br> **Dado** que dejo campos vacíos <br> **Cuando**  intento guardar <br> **Entonces** el sistema me alerta sobre los campos faltantes | EP06 |
| US29 | Cambio de contraseña | **Como** usuario **quiero**  poder cambiar mi contraseña desde el perfil **para** mantener la seguridad de mi cuenta | **Escenario 1:** <br> **Dado** que conozco mi contraseña actual <br> **Cuando**  ingreso una nueva válida <br> **Entonces** el sistema la actualiza y me muestra confirmación <br> **Escenario 2:** <br> **Dado** que ingreso una nueva contraseña que no cumple con el formato <br> **Cuando**  intento guardarla <br> **Entonces** el sistema me notifica sobre los requisitos mínimos | EP06 |
| US30 | Cambio de idioma | **Como** usuario **quiero**  poder cambiar el idioma de la aplicación web  **para** usarla en el idioma que prefiera | **Escenario 1:** <br> **Dado** que estoy usando la app <br> **Cuando** selecciono otro idioma <br> **Entonces** toda la interfaz se actualiza automáticamente al nuevo idioma | EP06 |
